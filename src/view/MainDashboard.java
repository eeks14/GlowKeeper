...
public class MainDashboard extends javax.swing.JFrame {
   ...
   public MainDashboard(ProductInventory inventory) {
    ...
    public void refreshWaitingQueueTable() {
        DefaultTableModel model = (DefaultTableModel) waitingQueueTable.getModel();
        model.setRowCount(0);

        List<String> queueElements = productController.getWaitingQueue().getAllElements();

        for (String productName : queueElements) {
    ...
    private void initComponents() {
        ...
        waitingQueueTable = new javax.swing.JTable();
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel9Layout.createSequentialGroup()
                ...
                .addComponent(jTextArea4, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jTextArea4, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(15, Short.MAX_VALUE))
        );
        ...
        jLabel31.setFont(new java.awt.Font("YuMincho +36p Kana", 0, 18)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(51, 51, 51));
        jLabel31.setText("Recently Added Products");
        ...
        jLabel9.setText("Waiting Product ");

        jPanel18.setBackground(new java.awt.Color(204, 204, 255));

        waitingQueueTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
            ...
            new String [] {
                "Product Name", "Brand", "Expiry Year"
            }
        ));
        jScrollPane7.setViewportView(waitingQueueTable);
        ...
        HomePanelLayout.setVerticalGroup(
            ...
            .addGroup(HomePanelLayout.createSequentialGroup()
                .addGroup(HomePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(HomePanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel17, javax.swing.GroupLayout.DEFAULT_SIZE, 490, Short.MAX_VALUE))
                    .addGroup(HomePanelLayout.createSequentialGroup()
                        .addGap(14, 14, 14)
    ...
    private void btnSave1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSave1ActionPerformed
        try {
            ...
            Product p = new Product(name, brand, category, expiryYear, quantity, suitability);
            productController.addProduct(p);  // adds to inventory AND waiting queue internally

            JOptionPane.showMessageDialog(this, "Product added successfully!");
            cardLayout.show(cardPanel, "productList");
            productController.loadProductTable(jTable3);   // refresh main product list

            refreshWaitingQueueTable();   // <-- Add this line to refresh waiting queue UI
    ...
    private void SearchbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchbtnActionPerformed
       ...
       if (key.isEmpty()) {
        ...
        else if (type.equals("Product Name (Partial)")) {
            

            // Call linear search by Name with list and key
            ArrayList<Product> results = productController.linearSearchByName(products, key);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        String acceptedProductName = productController.acceptProduct();
        if (acceptedProductName != null) {
            JOptionPane.showMessageDialog(this, "Accepted product: " + acceptedProductName);
            refreshWaitingQueueTable();
            productController.loadProductTable(jTable3);  // Refresh main product list if needed
        } else {
            JOptionPane.showMessageDialog(this, "No product to accept!");
        }
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        String deletedProductName = productController.deleteProduct();
        if (deletedProductName != null) {
            JOptionPane.showMessageDialog(this, "Deleted product from waiting queue: " + deletedProductName);
            refreshWaitingQueueTable();
            productController.loadProductTable(jTable3);  // Refresh main product list if needed
        } else {
            JOptionPane.showMessageDialog(this, "No product to delete!");
        }
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        String restoredProductName = productController.undoDelete();
        if (restoredProductName != null) {
            JOptionPane.showMessageDialog(this, "Restored product to waiting queue: " + restoredProductName);
            refreshWaitingQueueTable();
            productController.loadProductTable(jTable3);  // Refresh main product list if needed
        } else {
    ...
    private javax.swing.JTable waitingQueueTable;
